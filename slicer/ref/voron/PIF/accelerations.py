...
#
# * copy this file somewhere on your hard drive.
...
#
# * in Superslicer, add the following block of settings that the script will make use of somewhere to your:
#   Printer Settings > Custom GCode > Start GCode section, for example below your PRINT_START macro call
#   NOTE: remove the "#" symbol from the start of each setting line below. They all should start with the ";" as the first symbol
#
