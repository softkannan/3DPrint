...
def drawGear(design, diametralPitch, numTeeth, thickness, rootFilletRad, pressureAngle, backlash, holeDiam):
    try:
        ...
        #baseSketch.sketchCurves.sketchCircles.addByCenterRadius(adsk.core.Point3D.create(x,y,0), rootDia/2.0)
        ...
        if holeDiam - (_app.pointTolerance * 2) > 0:
            ...
            #baseSketch.sketchCurves.sketchCircles.addByCenterRadius(adsk.core.Point3D.create(x,y,0), holeDiam/2.0)
        ...
        #midPoint = adsk.core.Point3D.create((outsideDia / 2) + x, y, 0)
