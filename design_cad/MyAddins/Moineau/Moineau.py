...
class MoineauCommandCreatedHandler(adsk.core.CommandCreatedEventHandler):
    ...
    def notify(self, args):
        try:
            ...
            mainImage = inputs.addImageCommandInput('moineauImage', '', './Resources/Moineau.png')
            ...
            instructionsTextString += str('Modify parameters below. Note that extreme values may cause Fusion360 to lag.')
            ...
            lobeEntry.tooltip = "At least 2, values greater than 10 are disabled."
