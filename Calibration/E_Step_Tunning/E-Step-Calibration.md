...
![E-Step-Calibration_1f4ab.png](images/E-Step-Calibration_1f4ab.png) This page is compatible with Klipper, Marlin, and RepRapFirmware.

Extruder calibration simply ensures that 100mm requested = 100mm extruded.

This is separate from [![E-Step-Calibration_1f4c4.png](images/E-Step-Calibration_1f4c4.png) Extrusion Multiplier](https://ellis3dp.com/Print-Tuning-Guide/articles/extrusion_multiplier.html), which is a per-filament setting.
...
- Klipper / RepRapFirmware:
  ...
  ![E-Step-Calibration_klipper.png](images/E-Step-Calibration_klipper.png) Klipper
  
  - Open your printer.cfg and find the `[extruder]` section.3. Set `max_extrude_only_distance` to 101 or higher.4. *(+1 just helps avoid rounding error issues)*
  - Set `min_extrude_temp` to 0 if doing the test **cold**.
  - Run `RESTART`.
  
---

  ![E-Step-Calibration_duet.png](images/E-Step-Calibration_duet.png) RepRapFirmware
...
- [![E-Step-Calibration_1.png](images/E-Step-Calibration_1.png)](https://ellis3dp.com/Print-Tuning-Guide/articles/images/extruder_calibration/1.png)
- *Don’t worry if your ruler has extra length at the ends. We’re only taking a relative measurement.*
- [![E-Step-Calibration_ruler.png](images/E-Step-Calibration_ruler.png)](https://ellis3dp.com/Print-Tuning-Guide/articles/images/extruder_calibration/ruler.png)
...
- [![E-Step-Calibration_2.png](images/E-Step-Calibration_2.png)](https://ellis3dp.com/Print-Tuning-Guide/articles/images/extruder_calibration/2.png)
  
  [![E-Step-Calibration_3.png](images/E-Step-Calibration_3.png)](https://ellis3dp.com/Print-Tuning-Guide/articles/images/extruder_calibration/3.png)
  
- Extrude 100mm 

  ![E-Step-Calibration_26a0.png](images/E-Step-Calibration_26a0.png) **at 1mm/s**. 
  
  ![E-Step-Calibration_26a0.png](images/E-Step-Calibration_26a0.png)
...
- You can usually do this in your printer’s web interface, if equipped.
- G-codes:27. `M83 ; E relative`
- `G1 E100 F60 ; Extrude 100mm at 1mm/s (60mm/min)`
-
**Only use the LCD to extrude if it allows you to choose a speed.**
- [![E-Step-Calibration_4.png](images/E-Step-Calibration_4.png)](https://ellis3dp.com/Print-Tuning-Guide/articles/images/extruder_calibration/4.png)
-
Measure how much is left. Subtract it from 120 and note the value for later.

- **Example**33. I had 21mm left.
- 120mm - 21mm = **99mm actual extrusion**.
- [![E-Step-Calibration_5.png](images/E-Step-Calibration_5.png)](https://ellis3dp.com/Print-Tuning-Guide/articles/images/extruder_calibration/5.png)
-
Calculate your new `rotation_distance` / e-steps and activate it:
...
- Calculate your new `rotation_distance` using this formula:39. <new_rotation_distance> = <previous_rotation_distance> \* ( <actual_extrude_distance> / 100 )
...
![E-Step-Calibration_marlin.png](images/E-Step-Calibration_marlin.png) Marlin

- Run `M503`. In the output, find the `M92` line and note your current E value.43. [![E-Step-Calibration_M503.png](images/E-Step-Calibration_M503.png)](https://ellis3dp.com/Print-Tuning-Guide/articles/images/extruder_calibration/M503.png)
...
- Calculate your new e-steps using this formula:50. <new_e-steps> = <current_e-steps> \* ( 100 / <actual_extrude_distance> )
- Temporarily set your new e-steps with `M92`.
- Example: `M92 E421`.
...
-
![E-Step-Calibration_26a0.png](images/E-Step-Calibration_26a0.png) If you get different lengths in back-to-back tests, you have an **extruder issue**  
...
- Set your new e-steps with `M92`.60. Example: `M92 E421`.
...
---
-
![E-Step-Calibration_klipper_small.png](images/E-Step-Calibration_klipper_small.png) Klipper only:
